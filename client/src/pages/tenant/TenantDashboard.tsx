    ...
    <div className="-mx-4 sm:mx-0">
      ...
      <div className="sticky top-0 z-30 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold tracking-tight text-slate-700">Tenant Workspace</span>
          </div>

          <div className="flex items-center gap-2">
            <div className="hidden items-center gap-2 rounded-full border border-slate-200 bg-slate-100 px-3 py-1 sm:flex">
              <span className="text-slate-500" aria-hidden="true">
                <Icon name="tag" className="h-[18px] w-[18px]" />
              </span>
              <span className="text-xs font-medium text-slate-600">{tenantSlug}</span>
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-full border border-blue-600/20 bg-blue-600/10 text-blue-600">
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="space-y-2">
              ...
              <p className="flex flex-wrap items-center gap-2 text-sm text-slate-500">
                <span>
                  Tenant: <span className="font-medium text-slate-700">{tenantSlug}</span>
                </span>
              ...
              {tenantMeQ.isError ? (
                <p className="text-xs text-rose-600">Failed to resolve tenant context.</p>
              ) : null}
            </div>

            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link
                className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
        ...
        <section className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {/* Projects */}
          <div className="group cursor-default rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-blue-600/40 hover:shadow-md">
          ...
          <div className="group cursor-default rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-blue-600/40 hover:shadow-md">
            ...
            <div className="text-3xl font-bold text-slate-900">{activeTenantRole ?? "—"}</div>
            <p className="mt-2 text-xs text-slate-500">Tenant-scoped role</p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-1 border-l-4 border-blue-600 pl-4">
            <h3 className="text-xl font-bold text-slate-900">Workspace Overview</h3>
            <p className="text-sm text-slate-500">Manage your tenant resources and configuration.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {isTenantAdmin ? (
                <>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {/* Projects Management */}
                    <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-5 transition-shadow hover:shadow-md">
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <div className="rounded-lg bg-slate-50 p-2 text-slate-600">
                            <Icon name="inventory_2" className="h-5 w-5" />
                          </div>
                          <span className="inline-flex items-center gap-1 rounded-full bg-blue-600/10 px-2 py-0.5 text-[10px] font-bold text-blue-600">
                            <Icon name="security" className="h-3 w-3" /> ADMIN
                          </span>
                        </div>
                        <h4 className="font-bold text-slate-900">Projects Management</h4>
                      ...
                      <div className="mt-4">
                        <Link
                          className="inline-flex w-full items-center justify-center rounded-lg border border-slate-200 bg-white py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                          to={`/t/${tenantSlug}/projects`}
                        >
                          Manage Projects
                        </Link>
                    ...
                    <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-5 transition-shadow hover:shadow-md">
                      <div className="space-y-3">
                        ...
                        <h4 className="font-bold text-slate-900">Members / Team</h4>
                        <p className="text-xs leading-relaxed text-slate-500">
                    ...
                    <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-5 transition-shadow hover:shadow-md">
                      <div className="space-y-3">
                        ...
                        <h4 className="font-bold text-slate-900">Invite Users</h4>
                        <p className="text-xs leading-relaxed text-slate-500">
                    ...
                    <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-5 transition-shadow hover:shadow-md">
                      <div className="space-y-3">
                        ...
                        <h4 className="font-bold text-slate-900">Tenant Analytics</h4>
                        <p className="text-xs leading-relaxed text-slate-500">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-900">Member View</h4>
              ...
              <div className="flex items-start gap-3 rounded-xl border border-blue-100 bg-blue-50/60 p-4">
                ...
                <div>
                  <h5 className="text-sm font-bold text-blue-900">Access Notice</h5>
              ...
              <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="flex flex-1 flex-col justify-center space-y-4">
                  ...
                  <div className="pt-4 text-center">
                    <p className="text-xs font-medium text-slate-400">No recent activity available</p>
                  </div>
                </div>
              </div>
            </aside>
