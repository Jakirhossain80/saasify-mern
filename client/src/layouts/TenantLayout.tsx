...
export default function TenantLayout() {
  ...
  const linkActive = "bg-slate-900 text-white border-slate-900 shadow-sm";
  const linkIdle =
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 text-slate-900 antialiased">
      ...
      <header className="lg:hidden sticky top-0 z-40 flex items-center justify-between bg-white/95 backdrop-blur border-b border-slate-200 px-4 py-3 shadow-sm">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="font-bold text-slate-900 truncate">{tenantSlug}</div>
          </div>
        </div>
      ...
      <main
        ...
        className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 lg:py-8"
      >
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[280px_1fr]">
          ...
          <aside className="hidden lg:block">
            <nav
              ...
              className="sticky top-8 flex flex-col h-[calc(100vh-4rem)] bg-white border border-slate-200 rounded-2xl shadow-sm p-5 overflow-y-auto"
            >
              {/* Tenant Identity */}
              <div className="mb-8">
                ...
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <span className="inline-flex shrink-0 items-center px-2 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-600 border border-slate-200">
                    {activeTenantRole ??
                      (isLoadingTenantPerms ? "Loading" : "Unknown")}
                  </span>
                </div>
                ...
                {tenantPermsError && (
                  <div className="mt-4 rounded-xl border border-rose-200 bg-rose-50 p-4 text-xs text-rose-800">
                    ...
                    <div className="mt-2 text-rose-800/90">
                      Check:{" "}
                      <span className="font-medium">GET /api/t/:tenantSlug/me</span>
                    </div>
                    <div className="mt-1 text-rose-800/90">
                      Confirm you are an{" "}
                      <span className="font-medium">active member</span> of this tenant.
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100">
                <Link
                  to="/select-tenant"
                  className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium transition-colors text-sm group"
                >
          ...
          <section className="min-w-0">
            {/* Breadcrumb + Content shell (UI only; Outlet untouched) */}
            <nav aria-label="Breadcrumb" className="mb-6">
              <ol className="flex items-center space-x-2 text-[11px] font-bold uppercase tracking-wider text-slate-400">
                <li>Tenant</li>
                ...
                <li className="flex items-center space-x-2 text-slate-900">
                  <svg
                    className="h-3 w-3"
                    fill="currentColor"
                    viewBox="0 0 20 20"
